...
-- Date        : Tue Jul 19 11:23:26 2022
-- Host        : DESKTOP-DRQ34CR running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Zybo/Test1_github/project_1.srcs/sources_1/bd/design_1/ip/design_1_xbar_0/design_1_xbar_0_sim_netlist.vhdl
...
entity design_1_xbar_0_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  port (
    ...
    \gen_arbiter.m_amesg_i_reg[17]_2\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \gen_arbiter.m_amesg_i_reg[48]_0\ : out STD_LOGIC_VECTOR ( 34 downto 0 );
    f_hot2enc_return0 : out STD_LOGIC;
    \gen_arbiter.m_amesg_i_reg[17]_3\ : out STD_LOGIC;
...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  ...
  signal \^gen_arbiter.m_amesg_i_reg[17]_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[2]_i_1\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_5\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_2\ : label is "soft_lutpair3";
begin
  E(0) <= \^e\(0);
  SR(0) <= \^sr\(0);
  ...
  \gen_arbiter.m_amesg_i_reg[17]_3\ <= \^gen_arbiter.m_amesg_i_reg[17]_3\;
...
\gen_arbiter.m_grant_hot_i[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => \gen_arbiter.m_valid_i_reg_5\,
...
\m_atarget_enc[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \^gen_arbiter.m_amesg_i_reg[17]_3\
    );
...
\m_atarget_enc[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \gen_arbiter.m_amesg_i_reg[17]_2\(0)
    );
...
\m_atarget_hot[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \^gen_arbiter.m_amesg_i_reg[26]_0\,
      O => D(8)
    );
...
\m_atarget_hot[8]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAEABAAAA"
    )
        port map (
      I0 => \^gen_arbiter.m_amesg_i_reg[17]_3\,
      I1 => \^gen_arbiter.m_amesg_i_reg[48]_0\(25),
...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_20_splitter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_2\ : label is "soft_lutpair55";
...
architecture STRUCTURE of \design_1_xbar_0_axi_crossbar_v2_1_20_splitter__parameterized0\ is
  ...
  attribute SOFT_HLUTNM of \m_ready_d[1]_i_6\ : label is "soft_lutpair53";
begin
...
addr_arbiter_inst: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.m_amesg_i_reg[17]_0\ => addr_arbiter_inst_n_60,
      \gen_arbiter.m_amesg_i_reg[17]_1\ => addr_arbiter_inst_n_63,
      \gen_arbiter.m_amesg_i_reg[17]_2\(0) => any_error,
      \gen_arbiter.m_amesg_i_reg[17]_3\ => addr_arbiter_inst_n_101,
      \gen_arbiter.m_amesg_i_reg[26]_0\ => addr_arbiter_inst_n_61,
      ...
      \gen_arbiter.m_valid_i_reg_1\ => addr_arbiter_inst_n_27,
      \gen_arbiter.m_valid_i_reg_2\ => addr_arbiter_inst_n_41,
      \gen_arbiter.m_valid_i_reg_3\ => addr_arbiter_inst_n_50,
      \gen_arbiter.m_valid_i_reg_4\ => \gen_decerr.decerr_slave_inst_n_4\,
      \gen_arbiter.m_valid_i_reg_5\ => splitter_ar_n_1,
...
\gen_decerr.decerr_slave_inst\: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_decerr_slave
     port map (
      ...
      \gen_arbiter.m_grant_hot_i[1]_i_4_0\ => addr_arbiter_inst_n_102,
      ...
      \m_ready_d[1]_i_3_1\ => splitter_ar_n_6,
      m_valid_i_i_2_0 => reg_slice_r_n_40,
      m_valid_i_i_2_1 => reg_slice_r_n_39,
      m_valid_i_i_2_2 => reg_slice_r_n_41,
      mi_bvalid(0) => mi_bvalid(8),
      mi_wready(0) => mi_wready(8),
...
splitter_aw: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_splitter
     port map (
      aclk => aclk,
      \gen_arbiter.m_grant_hot_i[1]_i_4\ => reg_slice_r_n_41,
      \gen_arbiter.m_grant_hot_i[1]_i_4_0\ => splitter_ar_n_4,
      \gen_arbiter.m_grant_hot_i[1]_i_4_1\ => addr_arbiter_inst_n_7,
      \gen_arbiter.m_grant_hot_i_reg[1]\ => \gen_decerr.decerr_slave_inst_n_6\,
      \gen_arbiter.m_grant_hot_i_reg[1]_0\ => addr_arbiter_inst_n_27,
      \gen_arbiter.m_grant_hot_i_reg[1]_1\ => \gen_decerr.decerr_slave_inst_n_7\,
      \gen_arbiter.m_grant_hot_i_reg[1]_2\ => addr_arbiter_inst_n_2,
      m_atarget_enc(3 downto 0) => m_atarget_enc(3 downto 0),
...
entity design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar is
  ...
  attribute C_M_AXI_BASE_ADDR of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
  attribute C_M_AXI_READ_CONNECTIVITY of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  ...
  attribute C_M_AXI_WRITE_CONNECTIVITY of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
...
architecture STRUCTURE of design_1_xbar_0 is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
